...
public final class ArgumentChecks {
	...
	/**
	 * Validate that the argument condition is false, otherwise it throws an exception with a
	 * message passed as parameter. The exception is thrown as IllegalArgumentException.
	 * @param expression the boolean expression to check.
	 * @param message    the message to throw within the exception.
	 * @throws IllegalArgumentException with the given message if the expression is true.
	 */
	...
	/**
	 * Validate that the argument condition is false, otherwise it throws 
	 * an IllegalArgumentException with a default message.
	 * * @param expression the boolean expression to check.
